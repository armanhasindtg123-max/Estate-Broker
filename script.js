...
// ================================
const CONFIG = {
    whatsappNumber: '919143027808', // Replace with YOUR WhatsApp number (country code + number, no spaces or +)
    formSubmitWebhook: 'https://formsubmit.co/your-email@example.com' // Optional webhook
};
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (propertyForm) {
        ...
        budgetInput.addEventListener('change', function() {
            validateSelect(this, 'budgetError', 'Please select your budget range');
        });

        propertyTypeInput.addEventListener('change', function() {
            validateSelect(this, 'propertyError', 'Please select a property type');
        });
        ...
        propertyForm.addEventListener('submit', function(e) {
            ...
            const area = areaInput.value.trim() || 'Any area';
            
            console.log('Form data:', {fullName, phone, budget, propertyType, area}); // Debug log
            
            // Validate all fields
            const isNameValid = validateName(fullName);
            const isPhoneValid = validatePhone(phone);
            const isBudgetValid = validateSelect(budgetInput, 'budgetError', 'Please select your budget range');
            const isPropertyValid = validateSelect(propertyTypeInput, 'propertyError', 'Please select a property type');
            
            console.log('Validation:', {isNameValid, isPhoneValid, isBudgetValid, isPropertyValid}); // Debug log
